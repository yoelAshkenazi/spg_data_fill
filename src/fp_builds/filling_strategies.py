...
from src.fp_builds.feature_propagation import FeaturePropagation
...
def filling(filling_method, edge_index, X, feature_mask, num_iterations=None):
    """this method gets the filling method, missing data,
    adjacency matrix and the feature mask and returns the reconstructed data"""
